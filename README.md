...
[![Python 2.7]](#python-version-support) [![Available on PyPI.]](https://pypi.org/project/miniirc/) [![License: MIT]](https://github.com/luk3yx/miniirc/blob/master/LICENSE.md)
...
## Python version support
 ...
 - Python 2 should work with the latest stable version of miniirc.
 - Python 3 is not tested as thoroughly, however should work (and does with
    version 1.1.2).
